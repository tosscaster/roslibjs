...
export default class Ros extends EventEmitter<string | symbol, any> {
     ...
     */
    getActionServers(callback: (actionservers: string[]) => any, failedCallback?: (error: string) => any): void;
    /**
    ...
    getTopics(callback: (result: {
        topics: string[];
        types: string[];
    }) => any, failedCallback?: (error: string) => any): void;
    /**
     ...
     */
    getTopicsForType(topicType: string, callback: (topics: string[]) => any, failedCallback?: (error: string) => any): void;
    /**
     ...
     */
    getServices(callback: (services: string[]) => any, failedCallback?: (error: string) => any): void;
    /**
     ...
     */
    getServicesForType(serviceType: string, callback: (topics: string[]) => any, failedCallback?: (error: string) => any): void;
    /**
     ...
     */
    getNodes(callback: (nodes: string[]) => any, failedCallback?: (error: string) => any): void;
    /**
     ...
     * @param {getNodeDetailsFailedCallback} [failedCallback] - The callback function when the service call failed with params:
     */
    getNodeDetails(node: string, callback: (subscriptions: string[], publications: string[], services: string[]) => any, failedCallback?: (error: string) => any): void;
    /**
     ...
     */
    getParams(callback: (params: string[]) => any, failedCallback?: (error: string) => any): void;
    /**
     ...
     */
    getTopicType(topic: string, callback: (type: string) => any, failedCallback?: (error: string) => any): void;
    /**
     ...
     */
    getServiceType(service: string, callback: (type: string) => any, failedCallback?: (error: string) => any): void;
    /**
     ...
     */
    getMessageDetails(message: string, callback: (details: string) => any, failedCallback?: (error: string) => any): void;
    /**
