...
export default class Param {
     ...
     */
    get(callback: (value: any) => any, failedCallback?: (error: string) => any): void;
    /**
     ...
     */
    set(value: any, callback?: (response: any) => any, failedCallback?: (error: string) => any): void;
    /**
     ...
     * @param {setParamFailedCallback} [failedCallback] - The callback function when the service call failed.
     */
    delete(callback: (response: any) => any, failedCallback?: (error: string) => any): void;
}
